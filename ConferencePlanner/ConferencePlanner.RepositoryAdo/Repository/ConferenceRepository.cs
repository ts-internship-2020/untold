...
namespace ConferencePlanner.Repository.Ado.Repository
{
    public class ConferenceRepository : IConferenceRepository
    {
        ...
        {
            string commandText = "select vw.ConferenceId,vw.ConferenceName,vw.ConferencePeriod,vw.ConferenceTypeName,vw.ConferenceCategoryName,vw.LocationName,vw.SpeakerName from vwConferenceDetails vw "+
            "left join Attendee a on a.ConferenceId = vw.ConferenceId and a.AttendeeEmail = @Email " +
            "join Conference c on c.ConferenceId = vw.ConferenceId "+
            "where isnull(a.StatusId, 0)!= 3 and c.StartDate >= @StartDate and c.EndDate <= @EndDate ";
